...
- **Ageing / future demand** — population 65+ now (SAP2022 age tables: NUTS3 / county / small area) **and** [Regional Population Projections 2023–2042](https://www.cso.ie/en/releasesandpublications/ep/p-rpp/regionalpopulationprojections2023-2042/) for *where demand grows*: `PEC26` (projected population, single-year age × NUTS3 × year 2022–2042 × scenario M1/M2/M3 — derive 65+/85+) and `PEC28` (projected old-age dependency ratio × NUTS3). See [DOWNLOAD_MANIFEST.md](DOWNLOAD_MANIFEST.md).
